...
<body>
	...
	<?php
		...
		if ($_POST['registrarse']="registrarse"){
			...
			echo "<form class=registro method='POST' action='formusuario.php'>";	
			echo "<p class='titulop'>CREA UNA CUENTA</p>";
			echo "Nombre: <br>";
			...
			echo "E-mail (Longitud máxima de 30 carácteres): <br>";
			echo "<input type='text' max='30' name='info_email' required><br><br>";
			echo "Password (de 4 a 20 carácteres): <br>";
